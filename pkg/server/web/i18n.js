...
window.LOCALES = {
  en: {
    ...
    /* IPv4 class A–E and extended purpose tags */
    'hop-type-class-a':      'Class A',
    'hop-type-class-b':      'Class B',
    'hop-type-class-c':      'Class C',
    'hop-type-class-d':      'Class D',
    'hop-type-class-e':      'Class E',
    'hop-type-public':       'Public',
    'hop-type-cgnat':        'CGNAT',
    'hop-type-multicast':    'Multicast',
    'hop-type-reserved':     'Reserved',
    'hop-type-broadcast':    'Broadcast',
    'hop-type-documentation':'Documentation',
    'hop-type-6to4-relay':   '6to4 Relay',
    'hop-type-ipv6':         'IPv6',
  ...
  'zh-TW': {
    ...
    /* IPv4 分類 A–E 及延伸用途標簽 */
    'hop-type-class-a':      'A 類',
    'hop-type-class-b':      'B 類',
    'hop-type-class-c':      'C 類',
    'hop-type-class-d':      'D 類',
    'hop-type-class-e':      'E 類',
    'hop-type-public':       '外網',
    'hop-type-cgnat':        'CGNAT',
    'hop-type-multicast':    '多播',
    'hop-type-reserved':     '保留',
    'hop-type-broadcast':    '廣播',
    'hop-type-documentation':'文件',
    'hop-type-6to4-relay':   '6to4 中繼',
    'hop-type-ipv6':         'IPv6',
    /* ??? 逾時格的滑鼠提示文字 */
